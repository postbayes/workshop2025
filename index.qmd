...
Below are the confirmed keynote speakers (in alphabetical order).
...
Below are the confirmed contributed talks (in alphabetical order). 
These are talks which have been accepted by the scientific committee, and for which speakers have confirmed their attendance.
